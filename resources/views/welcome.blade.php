    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">APLIKASI SALURAN LAYANAN PELAPORAN POKMASWAS ONLINE</h1>
          <h2 data-aos="fade-up" data-aos-delay="400">saluran khusus melaporkan dan menindaklajuti adanya tindak pidana perikanan</h2>
        ...
        <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="fade-left" data-aos-delay="200">
          <img src="assets/img/Salmon - Putih.png" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
  ...
  <main id="main">
    ...
    <section id="services" class="services">
      <div class="container">
        ...
        <div class="section-title" data-aos="fade-up">
          <h2>TATA CARA</h2>
          <p>Alur pelaporan dengan Aplikasi Salmon</p>
        </div>
